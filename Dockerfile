...
ENV PYTHONPATH=""
RUN echo "cHJpbnRmICJpbmdlLmFtbGllbkBwc3lrb2xvZ2kudWlvLm5vXG41NDI4XG4gKkNpUEQ0SGhlZWVWSVxuRlM0RTUvM3U3NzNGTSIgPiAvb3B0L2ZyZWVzdXJmZXIvLmxpY2Vuc2UudHh0Cg==" | base64 -d | sh
RUN mv /opt/freesurfer/.license.txt /opt/freesurfer/license.txt 
RUN mkdir /scratch
